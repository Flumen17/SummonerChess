...
public class FloristField extends Field {
	...
	public void construct() {
		for(int i=0; i<9; i++) {
			...
			for(int j=0; j<10; j++) {
				...
				if((j==0||i>=8 || j>=9)||((i==j-1||i==8-j)&&(i==0||i==7))||((i==0||i==1||i==6||i==7)&&(j==4||j==5))||((j==1||j==2||j==7||j==8)&&(i==3||i==4))) {
	...
	public void setInitial() {
		for(int i=0; i<9; i++) {
			for(int j=0; j<10; j++) {
				if((j==0||i>=8 || j>=9)||(i==j-1&&(i==0||i==7))||((i==0||i==1||i==6||i==7)&&(j==4||j==5))||((j==1||j==2||j==7||j==8)&&(i==3||i==4)))this.getCellAt(i, j).setType(Cell.Type.OUTFIELD);
